  ...
  return new Settings({
      ...
      */
      datasources: {
        influxdb: {
          type: 'influxdb',
          url: "http://meleors.chinacloudapp.cn:8086/db/meleors",
          username: 'root',
          password: 'root',
        }
      },
      ...
      */
      ...
      plugins: {
        ...
        panels: {'custom panel name': { path: '../plugins/custom.panel.example' }},
        // requirejs modules in plugins folder that should be loaded
        // for example custom datasources
        dependencies: ['custom.panel.example/module.js']
      }
